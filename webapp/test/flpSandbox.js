		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idfilterszfilters-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idfilterszfilters-display": {
								"semanticObject": "idfilterszfilters",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idfilters.zfilters",
									"url": sap.ui.require.toUrl("idfilters/zfilters")
								}
							}
						}
					}
